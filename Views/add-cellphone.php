    ...
    <div class="content"> 
      <div id="comments" >
        ...
        <?php if(isset($message)){ ?>
               ...
               <?php } ?>
        <form action="<?php echo FRONT_ROOT ?>Cellphone/AddCellphone" method="post"  style="background-color: #EAEDED;padding: 2rem !important;">
          <table> 
            <thead>
              <tr>
                <th>Code</th>
            ...
            <tbody align="center">
              <tr>
                ...
                <td>
                  <input type="number" name="price" size="10" required>
                </td>         
              </tr>
              </tbody>
          </table>
